...
export default function FormCliente({ onSalvar, cliente, onCancelar }) {
  ...
  function handleSubmit(e) {
    e.preventDefault();
    if (!dados.nome || !dados.endereco.rua || !dados.endereco.numero || !dados.endereco.bairro || !dados.endereco.cidade || !dados.endereco.estado || !dados.telefones[0].ddd || !dados.telefones[0].numero) return;
